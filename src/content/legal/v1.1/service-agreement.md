...
This template supplements the Killough Works [Terms of Service](./TERMS_OF_SERVICE.md), [Privacy Policy](./PRIVACY_POLICY.md), [Refund Policy](./REFUND_POLICY.md), [AI Disclosure](./AI_DISCLOSURE.md), and [Intellectual Property Policy](./INTELLECTUAL_PROPERTY_POLICY.md).
...
**Provider:**  
Jonathan Killough d/b/a Killough Works  
...
If this Agreement covers a **Friction Check** or **First Fix**, it is a **Limited-Scope Engagement** as defined in the [Terms of Service](./TERMS_OF_SERVICE.md). It includes only the deliverables in Section 2.1. It does **not** include ongoing support, maintenance, monitoring, future updates, bug fixes for unrelated issues, platform changes made by third parties after delivery, or rework caused by Client or third-party modifications unless added by change order.
...
1. Provide accurate information, assets, and feedback  
2. Provide timely access to platforms, hosting, DNS, or tools needed for performance  
3. Remain solely responsible for maintaining current backups of websites, databases, content, and business systems before any live changes. Provider is not responsible for data loss, corruption, downtime, or restoration costs arising from missing, outdated, or failed backups  
4. Respond to requests within **[3–5] business days**  
5. Ensure Client Materials are lawful and properly licensed  
6. Review Deliverables before public release or production reliance  
7. Maintain Client-owned accounts for third-party services (hosting, Stripe, automation tools, etc.)
...
Refunds are governed by the Killough Works [Refund Policy](./REFUND_POLICY.md) unless this Agreement states different milestone-specific terms below:

**[OPTIONAL CUSTOM REFUND / KILL FEE LANGUAGE]**

### 4.6 Payment disputes and chargebacks

Client agrees to contact Provider at **jonathan@killough.works** regarding billing concerns before initiating a chargeback or payment dispute with a financial institution, when practicable. See Terms of Service Section 7.5 and the [Refund Policy](./REFUND_POLICY.md).
...
| Service type | Included revisions |
|--------------|-------------------|
| Friction Check | No implementation revisions; clarifying questions on takeaways within 7 days |
...
Client acknowledges Provider may use AI tools as described in the [AI Disclosure](./AI_DISCLOSURE.md). Client is responsible for final review before production use.
...
Ownership and licenses are governed by the [Intellectual Property Policy](./INTELLECTUAL_PROPERTY_POLICY.md), summarized here:
...
- Provider Materials are excluded from Client ownership even when embedded in Deliverables (see [Intellectual Property Policy](./INTELLECTUAL_PROPERTY_POLICY.md) Section 4.1)  
...
1. PROVIDER WILL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR LOST PROFITS, REVENUE, OR DATA.  
2. PROVIDER'S TOTAL LIABILITY FOR ANY CLAIM ARISING FROM THIS AGREEMENT WILL NOT EXCEED THE GREATER OF (A) THE FEES PAID BY CLIENT TO PROVIDER UNDER THIS AGREEMENT IN THE **TWELVE (12)** MONTHS PRECEDING THE CLAIM OR (B) ONE HUNDRED U.S. DOLLARS ($100).
...
**Added fee:** $[AMOUNT]  
**Added timeline:** [DAYS]  
**Impact on Deliverables:** [DESCRIBE]

**Approved:**

Provider: ___________________________  Date: _________  
...
*Related: [Terms of Service](./TERMS_OF_SERVICE.md) · [Refund Policy](./REFUND_POLICY.md) · [Intellectual Property Policy](./INTELLECTUAL_PROPERTY_POLICY.md)*