...
**Provider:** Jonathan Killough d/b/a Killough Works  
...
Jonathan Killough reviews work before delivery and remains responsible for what Killough Works sends you, subject to the limitations in our [Terms of Service](./TERMS_OF_SERVICE.md).
...
**[ATTORNEY REVIEW]:** If enterprise clients require a fixed vendor list or data-processing terms, document your actual toolchain and DPAs as needed.
...
1. **Review deliverables** before publishing, deploying, or relying on them in production
2. **Verify critical facts** in customer-facing copy (pricing, service area, legal claims, guarantees, dates, contact details)
3. **Test forms, automations, and payment paths** in your real environment before directing live traffic
4. **Confirm rights** to any content, images, trademarks, or data used in AI-assisted drafts
5. **Tell us** if your industry, jurisdiction, or platform prohibits or restricts AI-assisted work
...
We do not intentionally submit your confidential information to AI tools in ways that violate our [Privacy Policy](./PRIVACY_POLICY.md) or a signed confidentiality agreement.
...
Ownership and license terms for deliverables are governed by our [Intellectual Property Policy](./INTELLECTUAL_PROPERTY_POLICY.md) and any [Service Agreement](./SERVICE_AGREEMENT_TEMPLATE.md).
...
*Related: [Terms of Service](./TERMS_OF_SERVICE.md) · [Privacy Policy](./PRIVACY_POLICY.md) · [Intellectual Property Policy](./INTELLECTUAL_PROPERTY_POLICY.md)*